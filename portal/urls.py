...
from portal.views.teacher.teach_new import teacher_classes_new, teacher_class_new, teacher_view_class, \
    ...
    teacher_student_reset_new, teacher_delete_students_new, teacher_class_password_reset_new, teacher_move_students_new, \
    teacher_move_students_to_class_new, teacher_dismiss_students_new
